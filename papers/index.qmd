...
This is a list of my research papers, including [preprints](https://en.wikipedia.org/wiki/Preprint).


::: {.callout-tip}
You can find citation metrics and other outputs on [Google Scholar](https://scholar.google.com/citations?view_op=list_works&hl=en&user=uqivDeoAAAAJ&gmla=AElLoL1GAS7kTYCwjqpMxOFxXIl1jgbU9wINCmzMKv-QjUvP7N0cQRFg54zuHkuQfgr8qs8oSiPl1E_CcsOIPKvfWeIanJ17_Z4f-lmDM1RsSRJ8UKE).
:::
...
::: {.callout-note .callout-clear collapse="true" icon="false" appearance="minimal"}
## `ritest`: randomization inference in Python 🎲

---

**Abstract:** `ritest` is a Python package implementing RI in a workflow similar to Stata’s `ritest` command (Heß, 2017). It supports (i) a fast linear-model path for regression coefficients, and (ii) a generic path that accepts arbitrary user-defined statistics. For linear models, `ritest` additionally implements test inversion to obtain coefficient confidence interval (CI) bounds and a full $p(\beta_0)$ profile (“CI band”) over candidate null values, designed to be practical even with large permutation counts.
...
[project page](/projects/ritest/index.qmd)
,
[code](https://github.com/tabareCapitan/ritest)
,
[paper](https://github.com/tabareCapitan/ritest/tree/master/paper)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with many others (accepted pending minor revisions, <em>Nature</em>)
<br>
[<b>project page</b>](https://www.cos.io/score)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with Capitán
<br>
[<b>project page</b>](/projects/insects/index.qmd)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with Thunström, Van ‘t Veld, and Nordström</div>
:::
...
<div style="font-size: 0.80em;">coauthored with Méndez</div>
:::
...
<div style="font-size: 0.80em;">coauthored with Thunström, Van ‘t Veld, Nordström, and Shogren (<em>Journal of Risk and Uncertainty, 2026</em>)
<br>
[<b>journal (OA)</b>](https://doi.org/10.31235/osf.io/vy6af)
,
[<b>pdf</b>](https://link.springer.com/article/10.1007/s11166-025-09471-9)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with many others (accepted, <em>Nature</em>)
<br>
[<b>project page</b>](https://www.cos.io/score)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with many others (<em>Nature Human Behavior</em>, 2024)
<br>
[<b>journal (OA)</b>](https://doi.org/10.1038/s41562-024-01961-1)
,
[<b>pdf</b>](https://osf.io/preprints/metaarxiv/xdsjf/)
,
[<b>project page</b>](https://www.cos.io/score)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored as part of a large-scale collaboration with many others (<em>Royal Society Open Science</em>, 2024)
<br>
[<b>journal (OA)</b>](https://royalsocietypublishing.org/doi/10.1098/rsos.240682)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored as part of an <em>author-consortium</em> with many others (<em>Organizational Behavior and Human Decision Processes</em>, 2023)
<br>
[<b>journal (OA)</b>](https://www.sciencedirect.com/science/article/pii/S0749597823000560?via%3Dihub#s0170)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with Alpízar, Madrigal-Ballestero, and Pattanayak (<em>Resource and Energy Economics</em>, 2021)
<br>
[<b>journal (OA)</b>](https://doi.org/10.1016/j.reseneeco.2021.101264)
,
[<b>pre-print</b>](https://doi.org/10.31235/osf.io/wcz8s)
,
[<b>code</b>](https://github.com/tabareCapitan/CNFL)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with Albers, Ashworth, Madrigal-Ballestero, and Preonas (<em>Marine Resource Economics</em>, 2021)
<br>
[<b>journal</b>](https://www.journals.uchicago.edu/doi/10.1086/715818)
,
[<b>pdf</b>](https://static1.squarespace.com/static/5727ad5320c647e75d038f64/t/61b38f8281066a3c2f183e3b/1639157654899/Albers_etal_MRE.pdf)
,
[<b>project page</b>](/projects/mpa/index.qmd)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with Albers, Preonas, Robinson, and Madrigal-Ballestero (<em>Environmental and Resource Economics</em>, 2020)
<br>
[<b>journal (OA)</b>](https://doi.org/10.1007/s10640-020-00472-7)
,
[<b>project page</b>](/projects/mpa/index.qmd)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with many others (<em>Regional Environmental Change</em>, 2020)
<br>
[<b>journal (OA)</b>](https://doi.org/10.1007/s10113-020-01592-y)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with Madrigal-Ballestero, Salas, and Córdoba (<em>Waterlines</em>, 2019)
<br>
[<b>journal</b>](https://doi.org/10.3362/1756-3488.18-00020)
,
[<b>pdf</b>](https://www.researchgate.net/publication/338340783_Household_and_community_responses_to_seasonal_droughts_in_rural_areas_of_Costa_Rica)
</div>
:::
...
<div style="font-size: 0.80em;">coauthored with Madrigal-Ballestero, Albers, and Salas (<em>Ambio</em>, 2017)
<br>
[<b>journal</b>](https://doi.org/10.1007/s13280-017-0921-y)
,
[<b>pdf</b>](https://www.researchgate.net/profile/Roger_Madrigal-Ballestero/publication/316896515_Marine_protected_areas_in_Costa_Rica_How_do_artisanal_fishers_respond/links/5a2c89ae45851552ae7c9bdb/Marine-protected-areas-in-Costa-Rica-How-do-artisanal-fishers-respond.pdf)
,
[<b>project page</b>](/projects/mpa/index.qmd)
</div>
:::
