...
I've done this before in Stata, where a well-established command,[`ritest`](https://github.com/simonheb/ritest), covers most practical uses of randomisation inference. But I was working in Python. I found tools that cover some uses, but I did not find a functional equivalent to Stata's `ritest`.
