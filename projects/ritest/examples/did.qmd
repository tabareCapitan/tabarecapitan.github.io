...
This is a concise guide to implement the two-period transformation, you can find the complete script in the [repository](https://github.com/tabareCapitan/ritest/blob/master/documentation/examples/did.py).
